This app requires a proxy to access ZTM REST API. Go to `proxy` folder and run `node proxy.js`. It uses [CORS Anywhere](https://github.com/Rob--W/cors-anywhere).

Once the proxy is up and running you can launch the app by typing `npm start` in the root folder of the project.

Below is the original README.md generated by create-react-app
